...
const PartyDetail = () => {
  ...
  const fetchParty = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`/api/partys/${id}`);
      ...
      <Container className="py-5">
        <Alert variant="danger">
          ...
          <div className="d-flex justify-content-end">
            <Button variant="outline-danger" onClick={() => navigate('/partys')}>
              Back to Partys
            </Button>
          </div>
        </Alert>
    ...
    return (
      <Container className="py-5">
        <Alert variant="warning">
          ...
          <div className="d-flex justify-content-end">
            <Button variant="outline-warning" onClick={() => navigate('/partys')}>
              Back to Partys
            </Button>
          </div>
        </Alert>
          ...
          <Row className="align-items-center">
            ...
            <Col xs="auto">
              <div className="d-flex gap-2">
                <Button variant="outline-primary" onClick={() => navigate(`/partys/${id}/edit`)}>
